                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-6 col-md-9">
                            <div class="about__images-three tg-svg">
                                <img
                                    src="assets/img/others/inner_about_img.png"
                                    alt="img"
                                />
                                <span
                                    class="svg-icon"
                                        ...
                                        <div class="features__content-two">
                                            <div class="content-top">
                                                <div class="features__icon-two">
                                                    <img
                                                        src="assets/img/icons/h2_features_icon01.svg"
                                                        alt="img"
                                                        class="injectable"
                                                    />
                                                </div>
                                            ...
                                            <p>
                                                ...
                                                galley offe type and scrambled
                                                makes.
                                            </p>
                                        </div>
                                    ...
                                    <div class="features__item-two">
                                        <div class="features__content-two">
                                            <div class="content-top">
                                                <div class="features__icon-two">
                                                    <img
                                                        src="assets/img/icons/h2_features_icon02.svg"
                                                        alt="img"
                                                        class="injectable"
                                                    />
                                                </div>
                                    ...
                                    <div class="features__item-two">
                                        <div class="features__content-two">
                                            <div class="content-top">
                                                <div class="features__icon-two">
                                                    <img
                                                        src="assets/img/icons/h2_features_icon03.svg"
                                                        alt="img"
                                                        class="injectable"
                                                    />
                                                </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-xl-6">
                                    <div class="section__title white-title text-center mb-50">
                                        ...
                                        <p>
                                            Groove’s intuitive shared inbox
                                            makesteam members together <br />{" "}
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="features__item">
                                        ...
                                        <div class="features__content">
                                            ...
                                            <p>
                                                Curate anding area share
                                                Pluralsight content to reach
                                                your
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-xl-5">
                                        <div class="section__title text-center mb-50">
                                            ...
                                            <p>
                                                when known printer took a galley
                                                of type scrambl edmake
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                                            ...
                                                            <div class="testimonial__item-top">
                                                                <div class="testimonial__author">
                                                                    <div class="testimonial__author-thumb">
                                                                        <img
                                                                            src="assets/img/others/testi_author01.png"
                                                                            alt="img"
                                                                        />
                                                                    </div>
                                                        ...
                                                        <div class="testimonial__item">
                                                            <div class="testimonial__item-top">
                                                                <div class="testimonial__author">
                                                                    <div class="testimonial__author-thumb">
                                                                        <img
                                                                            src="assets/img/others/testi_author02.png"
                                                                            alt="img"
                                                                        />
                                                                    </div>
                                                                    <div class="testimonial__author-content">
                                                        ...
                                                        <div class="testimonial__item">
                                                            <div class="testimonial__item-top">
                                                                <div class="testimonial__author">
                                                                    <div class="testimonial__author-thumb">
                                                                        <img
                                                                            src="assets/img/others/testi_author03.png"
                                                                            alt="img"
                                                                        />
                                                                    </div>
                                                                    <div class="testimonial__author-content">
