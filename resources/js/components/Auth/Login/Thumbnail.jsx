...
const Thumbnail = () => {
  return (
    <section className="breadcrumb__area breadcrumb__bg" data-background="assets/img/bg/breadcrumb_bg.jpg" style={{ backgroundImage: "url(assets/img/bg/breadcrumb_bg.jpg)" }}>
