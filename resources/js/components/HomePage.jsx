...
const HomePage = () => {
    ...
    return (
        <div>
                        ...
                        <div className="col-xl-6 col-lg-8">
                            <div className="section__title text-center mb-40">
                                ...
                                <p>
                                    ...
                                    type and scrambled make <br /> specimen book
                    ...
                    <div className="row align-items-center justify-content-center">
                        <div className="col-lg-6">
                            <div className="faq__img-wrap tg-svg">
                                <div className="faq__img faq__img-two">
                                    <img
                                        src="assets/img/others/faq_img.png"
                                        alt="FAQ visual"
                                    />
                        ...
                        <div className="col-lg-6">
                            <div className="about__content">
                                ...
                                <p className="desc">
                                    Groove’s intuitive shared inbox makes it
                                    easy for team members to organize,
                                    prioritize, and manage their work. In this
                                    episode of the Smashing Pod, we’re talking
            ...
            <section
                class="courses-area section-py-110"
                ...
                <div class="container">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-6 col-lg-8">
                                <div class="section__title text-center mb-40">
                                    ...
                                    <p class="desc">
                                        When known printer took a galley of type
                                        scrambl edmake
                                    </p>
                                </div>
                    ...
                    <div class="all-courses-btn ">
                        <div class="tg-button-wrap justify-content-center">
                            <a href="courses.html" class="btn arrow-btn">
                                See All Courses{" "}
                                <img
                                    src="assets/img/icons/right_arrow.svg"
                                    alt="img"
                    ...
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-lg-6">
                            <div class="work__content">
                                ...
                                <p>
                                    Edhen an unknown printer took a galley of
                                    type and scrambled it to make a type
                                    specimen bookas survived not only five
                                    centuries.Edhen an unknown printer took a
                                    galley of type and scrambled.
                                </p>
                                <div class="work__list-wrap">
                                    <div class="work__list-box">
                                        ...
                                        <p>
                                            Edhen an unknown printer Rtook
                            ...
                            <div class="col-lg-12">
                                <div class="fact__inner-wrap-two">
                                    ...
                                    <div class="fact__img-wrap tg-svg">
                                        <img
                                            src="assets/img/others/fact_img.png"
                                            alt="img"
                                        />
                                        <div class="shape-one">
                                            <img
                                                src="assets/img/others/fact_shape01.svg"
                                                alt="img"
                                                class="injectable"
                                            />
                                        </div>
                                        <div class="shape-two">
                                            <span
                                                class="svg-icon"
                                                id="fact-btn"
                                                data-svg-icon="assets/img/others/fact_shape02.svg"
                                            ></span>
                                        </div>
                                    </div>
                                </div>
            ...
            <section
                class="instructor__area-three instructor__bg"
                data-background="assets/img/bg/instructor_bg.jpg"
            >
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-xl-6 col-lg-8">
                            <div class="section__title text-center mb-40">
                                ...
                                <h2 class="title">
                                    Our Top Class & Professional Instructors in
                                    One Place
                                </h2>
                            </div>
                        </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="instructor__item-three">
                                            <div class="instructor__thumb-three">
                                                <img
                                                    src="assets/img/instructor/h2_instructor01.png"
                                                    alt="img"
                                                />
                                                <div class="shape-one">
                                                    <img
                                                        src="assets/img/instructor/h2_instructor_img_shape01.svg"
                                                        alt="img"
                                                        class="injectable"
                                                    />
                                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="instructor__item-three">
                                            <div class="instructor__thumb-three">
                                                <img
                                                    src="assets/img/instructor/h2_instructor02.png"
                                                    alt="img"
                                                />
                                                <div class="shape-one">
                                                    <img
                                    ...
                                    <div class="swiper-slide">
                                        <div class="instructor__item-three">
                                            <div class="instructor__thumb-three">
                                                <img
                                                    src="assets/img/instructor/h2_instructor03.png"
                                                    alt="img"
                                                />
                                                <div class="shape-one">
                                                    <img
                                    ...
                                    <div class="swiper-slide">
                                        <div class="instructor__item-three">
                                            <div class="instructor__thumb-three">
                                                <img
                                                    src="assets/img/instructor/h2_instructor04.png"
                                                    alt="img"
                                                />
                                                <div class="shape-one">
                                                    <img
                                    ...
                                    <div class="swiper-slide">
                                        <div class="instructor__item-three">
                                            <div class="instructor__thumb-three">
                                                <img
                                                    src="assets/img/instructor/h2_instructor05.png"
                                                    alt="img"
                                                />
                                                <div class="shape-one">
                                                    <img
                        ...
                        <div class="col-xl-9">
                            <div class="instructor-slider-dot">
                                <div class="swiper instructor-nav">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <button>
                                                <img
                                                    src="assets/img/instructor/instructor_nav01.png"
                                                    alt="img"
                                                />
                                            </button>
                                        </div>
                                        <div class="swiper-slide">
                                            <button>
                                                <img
                                                    src="assets/img/instructor/instructor_nav02.png"
                                                    alt="img"
                                                />
                                            </button>
                                        </div>
                                        <div class="swiper-slide">
                                            <button>
                                                <img
                                                    src="assets/img/instructor/instructor_nav03.png"
                                                    alt="img"
                                                />
                                            </button>
                                        </div>
                                        <div class="swiper-slide">
                                            <button>
                                                <img
                                                    src="assets/img/instructor/instructor_nav04.png"
                                                    alt="img"
                                                />
                                            </button>
                                        </div>
                                ...
                                <div class="instructor__nav-two">
                                    <div class="instructor-button-prev">
                                        <i class="flaticon-arrow-right"></i>
                                    </div>
                                    <div class="instructor-button-next">
                                        <i class="flaticon-arrow-right"></i>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="instructor__shape">
                    <img
                        src="assets/img/instructor/h2_instructor_shape.png"
                        alt="img"
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-4">
                            <div className="newsletter__img-wrap">
                                <img
                                    src="assets/img/others/newsletter_img.png"
                                    alt="Newsletter"
                                />
                                <img
                            ...
                            <div class="col-30">
                                <div class="event__content">
                                    <div class="section__title mb-20">
                                        ...
                                        <h2 class="title">
                                            Join Our Community And Make it
                                            Bigger
                                        </h2>
                                    </div>
                                    <p>
                                        Edhen an unknown printer took a galley
                                        acrambled make a type specimen bookas
                                        centuries.Edhen anderely unknown printer
                                        took a galley.
                                    </p>
                                    <div class="tg-button-wrap">
                                        <a
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="blog__post-item shine__animate-item">
                                <div class="blog__post-thumb">
                                    ...
                                    >
                                        <img
                                            src="assets/img/blog/blog_post01.jpg"
                                            alt="img"
                                        />
                                    </a>
                                ...
                                <div class="blog__post-content">
                                    ...
                                    <h4 class="title">
                                        <a href="blog-details.html">
                                            How To Become idiculously Self-Aware
                                            In 20 Minutes
                                        </a>
                                    </h4>
                                </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="blog__post-item shine__animate-item">
                                ...
                                <div class="blog__post-content">
                                    ...
                                    <h4 class="title">
                                        <a href="blog-details.html">
                                            Get Started With UI Design With Tips
                                            To Speed
                                        </a>
                                    </h4>
                                </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="blog__post-item shine__animate-item">
                                <div class="blog__post-thumb">
                                    ...
                                    >
                                        <img
                                            src="assets/img/blog/blog_post03.jpg"
                                            alt="img"
                                        />
                                    </a>
                                    <a href="blog.html" class="post-tag">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="blog__post-item shine__animate-item">
                                <div class="blog__post-thumb">
                                    ...
                                    >
                                        <img
                                            src="assets/img/blog/blog_post04.jpg"
                                            alt="img"
                                        />
                                    </a>
                                    <a href="blog.html" class="post-tag">
                                ...
                                <div class="instructor__item-two tg-svg">
                                    ...
                                    <div class="instructor__content-two">
                                        ...
                                        <p>
                                            ...
                                            us undertakes physical exercise yes
                                            is this happen here.
                                        </p>
                                        <div class="tg-button-wrap">
                                            <a
                            ...
                            <div class="col-xl-6">
                                <div class="instructor__item-two tg-svg">
                                    ...
                                    <div class="instructor__content-two">
                                        ...
                                        <p>
                                            Join millions of people from around
                                            the world learning together. Online
                                            learning.
                                        </p>
                                        <div class="tg-button-wrap">
                                            <a
